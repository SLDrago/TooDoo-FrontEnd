...
const DeleteConfirmation = ({ isOpen, onClose, confirmation }) => {
      ...
      <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-10 px-2">
        <div className="bg-white w-full mx-2 sm:w-1/5 rounded-xl shadow-2xl p-4">
          ...
          <div className="font-light text-lg p-4">
            This process cannot be undone. Are you sure to delete this task?
          </div>
          <div className="items-center grid grid-cols-2 gap-2 p-4">
            <button
              className="bg-gray-700 text-white shadow-md hover:bg-gray-800 rounded-lg p-2 font-bold"
              onClick={onClose}
            >
              Cancel
            </button>
            <button
              className="bg-red-500 text-white shadow-md hover:bg-red-600 rounded-lg p-2 font-bold"
